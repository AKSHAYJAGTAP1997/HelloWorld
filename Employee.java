class Employee implements Comparable<Employee>{
	...
	@Override
	public int compareTo(Employee e){// this nis comparibke method in this we can pass only 1 condition at a time so we shifted to comparator for multiple sorting
	...
	System.out.println("sorted according to gender");
